                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    ...
                                    name_1 = (0, various_1.fromUTF8Array)(__spreadArray([], thisSlice.slice(4, 36), true));
...
programCommand('show')
    .option('--cache-path <string>')
    .action(function (directory, cmd) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, keypair, env, cacheName, cachePath, cacheContent, walletKeyPair, anchorProgram, candyMachine, machine, e_1, config;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
...
programCommand('create_candy_machine')
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 5:
                _b = _c.sent(), candyMachine = _b[0], bump = _b[1];
