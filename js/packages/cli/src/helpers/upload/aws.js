        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    return [3 /*break*/, 4];
                case 4:
                    url = "https://" + awsS3Bucket + ".s3.amazonaws.com/" + filename;
...
function awsUpload(awsS3Bucket, file, manifestBuffer) {
    return __awaiter(this, void 0, void 0, function () {
        var REGION, s3Client, filename, fileStream, mediaUrl, manifestJson, updatedManifestBuffer, metadataFilename, metadataUrl;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    REGION = 'us-east-1';
                    s3Client = new client_s3_1.S3Client({ region: REGION });
                    filename = "assets/" + (0, path_1.basename)(file);
                    loglevel_1["default"].debug('file:', file);
                    loglevel_1["default"].debug('filename:', filename);
                    fileStream = (0, fs_1.createReadStream)(file);
                    return [4 /*yield*/, uploadFile(s3Client, awsS3Bucket, filename, 'image/png', fileStream)];
                case 1:
                    mediaUrl = _a.sent();
                    ...
                    metadataFilename = filename.replace(/.png$/, '.json');
