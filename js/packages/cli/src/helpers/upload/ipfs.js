...
function ipfsUpload(ipfsCredentials, image, manifestBuffer) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    tokenIfps = ipfsCredentials.projectId + ":" + ipfsCredentials.secretKey;
                ...
                case 1:
                    ...
                    mediaUrl = "https://ipfs.io/ipfs/" + mediaHash;
                    loglevel_1["default"].debug('mediaUrl:', mediaUrl);
                    authIFPS = Buffer.from(tokenIfps).toString('base64');
                    return [4 /*yield*/, (0, node_fetch_1["default"])("https://ipfs.infura.io:5001/api/v0/pin/add?arg=" + mediaHash, {
                            headers: {
                ...
                case 4:
                    ...
                    return [4 /*yield*/, (0, node_fetch_1["default"])("https://ipfs.infura.io:5001/api/v0/pin/add?arg=" + manifestHash, {
                            headers: {
                                Authorization: "Basic " + authIFPS
                            },
                            method: 'POST'
                ...
                case 6:
                    _a.sent();
                    link = "https://ipfs.io/ipfs/" + manifestHash;
